...
function calculateVancomycin() {
  ...
  if (document.getElementById('v_summaryOutput')) document.getElementById('v_summaryOutput').innerHTML = summaryHTML;
...
function vancocopyClinicalNote() {
  ...
  const htmlContentDiv = document.getElementById('v_clinicalNoteContent');
  ...
  navigator.clipboard.write([clipboardItem]).then(() => {
    const button       = document.querySelector('#tab-vanco .copy-button');
